    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="pb-2">
            <span className="absolute aspect-square w-28 top-1 left-0 hidden rounded-full bg-blue-100 p-1 font-heading text-8xl text-blue-500 opacity-25 md:block">
              1
            </span>{" "}
        ...
        <div className={"relative col-span-12 pb-8 text-center lg:col-span-5"}>
          ...
          <p className="pb-2">
            ...
            Test your TailwindCSS classes in record speed.
            <br />
            &nbsp;
          </p>
          <div className={"overflow-hidden rounded-md border border-gray-800"}>
        ...
        >
          ...
          <p className="pb-2">
            <span className="rounded-full bg-blue-100 p-1 text-blue-500 text-8xl left-0 md:block hidden opacity-25 font-heading absolute aspect-square w-28 top-1">
              3
            </span>{" "}
