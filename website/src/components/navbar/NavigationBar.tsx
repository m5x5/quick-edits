...
export default function NavigationBar() {
	...
	return (
		<header className="py-1 fixed top-0 bg-white grid grid-cols-full col-start-1 z-20 w-full">
			<div className="flex items-center justify-between col-start-2 col-span-12">
				...
				>
					<div
						className={`flex flex-col w-full top-14 fixed bg-gradient-light inset-0 navigation--mobile ${open ? "active" : ""}`}
					>
