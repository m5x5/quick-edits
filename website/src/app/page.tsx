...
import { IconBrandChrome, IconBrandGithub, IconBrandX } from "@tabler/icons-react";
    ...
    <>
      ...
      <div className="fixed inset-0 grid grid-cols-full z-20 pointer-events-none">
        <div className="col-start-[13] flex justify-end">
          <div className="flex flex-col justify-end items-end pb-24 [&>*]:pointer-events-auto">
            <button className="hidden border border-dark-700 p-3 bg-black rounded-md translate-x-1/2" type="button">
              <svg
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        <main className="flex-1">
          <section className="mx-auto grid grid-flow-col grid-cols-full py-12 md:pt-24 md:pb-24 lg:py-32 w-full" aria-label={"Hero Sektion"}>
                ...
                <div className="flex flex-col justify-center space-y-4">
                  <div className="space-y-2">
                    <h1 className="pb-5 font-heading font-semibold text-4xl tracking-tight sm:text-5xl xl:text-6xl/none text-balance">
                      Find and edit your code with <span className="text-blue-500">ease</span>.
                    </h1>
                    <p className="!mt-0 max-w-[600px] text-black md:text-base pb-3">
                      Quick Edits is a developer utility that helps you locate the code you need to edit.
                    </p>
                  </div>
              ...
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[900px] text-gray-500 lg:text-base/relaxed">
                    Quick Edits is still in it&apos;s early stages but I&apos;m always open for a chat. Feel free to reach out to me on X or LinkedIn.
                  </p>
                </div>
