              ...
              <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px] w-full">
                <div className="flex flex-col justify-center space-y-4">
                  <div className="space-y-2">
                    <h1 className="pt-1 text-4xl font-bold tracking-tight sm:text-5xl xl:text-6xl/none pb-5">
                      This extension does not collect any personal data and will not do so in the foreseeable future.
                    </h1>
                    <p className="!mt-0 max-w-[600px] text-gray-500 md:text-base dark:text-gray-400 pb-3">
                      If you clone the repository from GitHub to install the &quot;native search module&quot; be sure to read the privacy policy of GitHub.
                    </p>
                  </div>
                  <div className="flex flex-col gap-2 min-[400px]:flex-row flex-wrap">
                    <Link
                      className="inline-flex h-10 items-center gap-2 justify-center rounded-md bg-gray-900 px-8 text-sm font-medium text-gray-50 shadow transition-colors hover:bg-gray-900/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50/90 dark:focus-visible:ring-gray-300"
                      href="https://github.com/m5x5"
                      target={"_blank"}
                    >
                      Get it on GitHub (Link will soon be fixed) <IconBrandGithub />
                    </Link>
                  </div>
                </div>
              </div>
